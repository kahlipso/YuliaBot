...
import { EventSubAutoModMessageHoldV2Subscription } from "./subscriptions/EventSubAutoModMessageHoldV2Subscription.mjs";
import { EventSubAutoModMessageUpdateV2Subscription } from "./subscriptions/EventSubAutoModMessageUpdateV2Subscription.mjs";
...
import { EventSubChannelSharedChatSessionBeginSubscription } from "./subscriptions/EventSubChannelSharedChatSessionBeginSubscription.mjs";
import { EventSubChannelSharedChatSessionUpdateSubscription } from "./subscriptions/EventSubChannelSharedChatSessionUpdateSubscription.mjs";
import { EventSubChannelSharedChatSessionEndSubscription } from "./subscriptions/EventSubChannelSharedChatSessionEndSubscription.mjs";
...
let EventSubBase = class EventSubBase extends EventEmitter {
    ...
    onAutoModMessageHoldV2(broadcaster, moderator, handler) {
        ...
        return this._genericSubscribe(EventSubAutoModMessageHoldV2Subscription, handler, this, broadcasterId, moderatorId);
    }
    /**
    ...
    onAutoModMessageUpdateV2(broadcaster, moderator, handler) {
        ...
        return this._genericSubscribe(EventSubAutoModMessageUpdateV2Subscription, handler, this, broadcasterId, moderatorId);
    }
    /**
